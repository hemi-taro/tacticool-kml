...
Color欄は小さいネイティブカラーピッカーとプリセット色から選択できます。Object Listの色スウォッチからLine colorを変更できます。項目を展開すると、名前とFill colorを変更できます。

SAM RingとCustom Areaのpolygon fillは初期状態では無効です。ONにするとFill colorが表示されます。
